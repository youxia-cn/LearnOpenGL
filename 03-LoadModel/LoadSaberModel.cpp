...
class MyApp : public App {
    ...
    public:
        void init(){            
            ...
            saber.loadModel("saber_bride/saber_bride_v_1.0.obj");
        ...
        void display(){
            ...
            glm::mat4 saber_model_matrix = glm::translate(I, glm::vec3(0.0f, -1.0f, -1.0f)) 
                                        * glm::rotate(I, glm::radians(180.0f), Y)
                                        * glm::scale(I, glm::vec3(2.0f, 2.0f, 2.0f));
